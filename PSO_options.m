...
%
% Purpose:
%   Defines the configuration parameters for the Particle Swarm Optimization
%   algorithms used in the gravity-inversion experiments.
%
% Description:
%   This script sets the inversion options, time-step parameters, PSO-family
%   algorithm selection, search-space projection settings, and particle-cloud
%   parameters required by the optimization routine pso_grav3D.
%
%   The RR scheme (algo_type = 5) corresponds to the RR-GPSO algorithm used
%   in the experiments reported in the associated manuscript.
%
% Required variables:
%   algo_type - Integer specifying the PSO-family algorithm to be used.
%
% Outputs:
%   options   - Structure containing the inversion and PSO configuration.
%   opfun     - Structure containing problem-dependent PSO parameters.
%
% Dependencies:
%   Particle-cloud parameter files (cloud_*.mat) corresponding to the
%   selected PSO-family algorithm.
%
% Authors:
...
%
% This repository version preserves the computational configuration used
% in the associated gravity-inversion experiments.
%*******************************************************************************
